public class Exe07 {
	...
	public static void main(String[] args) {
		...
		System.out.println("=====================================================================");
		System.out.print("Escolha uma opaoo abaixo \n");
		...
		System.out.print("Digite uma opaoo: ");
		...
		while (opcao != 0) {
			if (opcao == 1) {
				...
				System.out.print("Digite uma opaoo valida! \n");
				soma = soma - 1;
			}
		...
		System.out.println("=====================================================================");
		System.out.println("Situa��o\t\t\t\t |  Quantidade  | Porcentagem");
